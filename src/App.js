    ...
    <div className="app">
      <Router>
        <Routes>
            ...
            <Route path="/edit-profile" exact element={ user ? <EditProfile /> : <Navigate to="/login" /> } />
            
            <Route path="/messages" exact element={ user ? <MessageList /> : <Navigate to="/login" /> } />
            <Route path="/reply-message" exact element={ user ? <ReplyMessage /> : <Navigate to="/login" /> } />
            ...
            <Route path="/edit-contact" exact element={ user ? <EditContact /> : <Navigate to="/login" /> } />
